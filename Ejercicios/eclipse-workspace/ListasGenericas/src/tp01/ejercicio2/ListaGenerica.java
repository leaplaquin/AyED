...
/**
 * ListaDeEnteros es una clase abstracta que define los metodos que deberan
 * implementar todas aquellas clases que quieran representar una coleccion de
 * numeros enteros, extendiendo esta clase
 * */
public abstract class ListaGenerica<T> {
	...
	/**
	 * devuelve true si nos encontramos en el ultimo elemento de la lista,
	 ...
	 * dicha posicion, el mismo se reubicara a continuacion del elemento que
